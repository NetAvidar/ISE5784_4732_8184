    ...
    public void ourPicture() {
        ...
        //scene.geometries.add(
              //  new Plane(new Point(0, -600, 0), new Point(1, -600, 0), new Point(0, -600, 1))
                ...
                //first floar-
                new Sphere(60,new Point(-80,-100,0)).setEmission(new Color(0,30,200))  .setMaterial(new Material().setKd(0.3).setKs(0.5).setShininess(60)),//blue
                new Sphere(60,new Point(160,-100,0)).setEmission(new Color(300,0,200)) .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(60)),//pink
                new Sphere(60,new Point(40,-100,0)).setEmission(new Color(200,0,30)) .setMaterial(new Material().setKd(0.3).setKs(0.8).setShininess(60)),//red

                new Sphere(60,new Point(-20,-100,110)).setEmission(new Color(200,200,200)).setMaterial(new Material().setKd(0.5).setKs(0.8).setShininess(60)), //gray
                new Sphere(60,new Point(100,-100,110)).setEmission(new Color(100,12,200)).setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)),//purple
