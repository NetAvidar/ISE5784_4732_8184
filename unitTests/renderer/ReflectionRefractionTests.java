...
public class ReflectionRefractionTests {
    ...
    public void trianglesTransparentSphere() {
        scene.geometries.add(
                ...
                new Triangle(new Point(-150, -150, -115), new Point(-70, 70, -140), new Point(75, 75, -150))
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)),
                new Sphere(30,new Point(60, 50, -50)).setEmission(new Color(BLUE))
    ...
    @Test
    void ourImage() {
        Scene  ourScene  = new Scene("Our image");
        ourScene.setBackground(new Color(0, 102, 255));
        cameraBuilder
                .setDirection(new Vector(0, 1, 0), //up
                        new Vector(0, 0, -1))//to
        ...
        ourScene.geometries.add(new Sphere(20, new Point(0, 10, 0))
        ...
        ourScene.lights.add(new PointLight(new Color(255, 255, 255), new Point(-30, 0, 30)).setKq(0.0001).setKl(0.0001));
