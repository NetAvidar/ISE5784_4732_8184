...
public class LightsTests {
    ...
    private final Camera.Builder camera1                 = Camera.getBuilder()
            ...
            .setDirection(new Vector(0,1,0), new Vector(0,0,-1)) //change fron (0,0,0) to (0,0,-1)
    ...
    /** Position of the light in tests with sphere */
    private final Point          sphereLightPosition1     = new Point(-50, -50, 25);
    /** Light direction (directional and spot) in tests with sphere */
    private final Vector         sphereLightDirection1    = new Vector(1, 1, -0.5);
    private final Vector         sphereLightDirection2    = new Vector(1, 2, -1);
    /** Light color for tests with sphere */
    private final Color          sphereColor1        = new Color(250, 140, 0);
    private final Color          sphereColor2        = new Color(47, 255, 100);

    @Test
    public void ShperePointAndDirectional() {
        scene2.geometries.add(sphere);
        scene2.lights.add(new PointLight(sphereColor1,sphereLightPosition1).setKl(0.002).setKq(0.0001));
        scene2.lights.add(new DirectionalLight(sphereColor2,sphereLightDirection2));

        camera2.setImageWriter(new ImageWriter("ShperePointAndDirectional", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    @Test
    public void triangleSpotAndDirectional()
    {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(sphereLightColor, sphereLightPosition, sphereLightDirection).setKl(0.0001).setKq(0.0001));
        scene2.lights.add(new DirectionalLight(trianglesLightColor, trianglesLightDirection));


        camera2.setImageWriter(new ImageWriter("lightTrianglesSpotAndDirectional", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
